...
<t:admin-card-wrapper title="Create new user">
	<jsp:body>
		<t:card method="BBRUsers" gridPage="admin-user-list.jsp" title="Create new user">
			...
			<t:card-item label="Role" field="role" type="select" options="1:Visitor,2:Pos specialist,4:Pos administrator,8:Shop administrator,256:BBR Service Owner" isRequired="required" />		</t:card>
	</jsp:body>
